...
open class BoardItemsAdapter(private val context: Context, private val list: ArrayList<Board>) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        val ivBoardImage = holder.itemView.findViewById<CircleImageView>(R.id.iv_board_image)
        val tvName = holder.itemView.findViewById<TextView>(R.id.tv_name)
        val tvCreatedBy = holder.itemView.findViewById<TextView>(R.id.tv_created_by)
